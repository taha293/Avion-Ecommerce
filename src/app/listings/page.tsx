    ...
    <div>
      ...
      <div className="px-6 py-2 flex justify-between">
        <div className="flex gap-3">
            ...
            <button className="hidden lg:block py-3 px-6 font-[Satoshi-Regular] leading-6 text-[16px] text-darkprimary ">Product type &thinsp; <span className="text-[10px]">&#9660;</span> </button>
            ...
            <button className="hidden lg:block py-3 px-6 font-[Satoshi-Regular] leading-6 text-[16px] text-darkprimary ">Brand &thinsp; <span className="text-[10px]">&#9660;</span> </button>
        ...
        <div className="flex gap-4 items-center">
            ...
            <button className="hidden lg:block py-3 px-6 font-[Satoshi-Regular] leading-6 text-[16px] text-darkprimary ">Date added &thinsp; <span className="text-[10px]">&#9660;</span> </button>
          </div>
